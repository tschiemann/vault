...
COMMON_NAME="common"
TTL="72h"
TMP_TEST_RESULTS="pki-tmp-results"
...
#
## List issuer
#VAULT_ISSUERS=$("$binpath" list -format=json "${MOUNT}/issuers" | jq -r '.[]')
#[[ -z "$VAULT_CERTS" ]] && fail "VAULT_ISSUERS should include vault issuers"